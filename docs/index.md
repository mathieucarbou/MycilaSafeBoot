...
custom_safeboot_url = https://github.com/mathieucarbou/MycilaSafeBoot/releases/download/v3.2.10/safeboot-esp32dev.bin
```
...
Downloading SafeBoot image from https://github.com/mathieucarbou/MycilaSafeBoot/releases/download/v3.2.10/safeboot-esp32dev.bin
    Offset | File
